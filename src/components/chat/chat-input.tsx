...
export function ChatInput({
  ...
  return (
    <div className="mx-auto max-w-4xl">
      ...
      <div className="flex items-center gap-1.5 rounded-full border border-[#b6c4ff]/15 bg-black/30 px-4 py-2 backdrop-blur-sm transition-all duration-300">
        ...
        <input
          className="flex-1 bg-transparent text-sm text-[#e3e2e7] placeholder-[#8d90a2]/50 outline-none disabled:cursor-not-allowed disabled:opacity-40"
        ...
        <div className="flex items-center gap-1 shrink-0">
          <button className="flex size-7 items-center justify-center rounded-md text-[#8d90a2] transition-colors hover:text-[#b6c4ff] disabled:cursor-not-allowed disabled:opacity-30" disabled={isStreaming}>
            <Mic size={15} />
          </button>
          {isStreaming ? (
            <button
